...
from aura.subcommands import clipboard, emoji, record, resizer, scheme, screenshot, shell, toggle, wallpaper
from aura.utils.paths import wallpapers_dir
from aura.utils.scheme import get_scheme_names, scheme_variants
from aura.utils.wallpaper import get_wallpaper


def parse_args() -> (argparse.ArgumentParser, argparse.Namespace):
    parser = argparse.ArgumentParser(prog="aura", description="Main control script for the Aura dotfiles")
