...
c_config_dir = config_dir / "aura"
c_data_dir = data_dir / "aura"
c_state_dir = state_dir / "aura"
c_cache_dir = cache_dir / "aura"
...
wallpapers_dir = os.getenv("AURA_WALLPAPERS_DIR", pictures_dir / "Wallpapers")
...
screenshots_dir = os.getenv("AURA_SCREENSHOTS_DIR", pictures_dir / "Screenshots")
screenshots_cache_dir = c_cache_dir / "screenshots"

recordings_dir = os.getenv("AURA_RECORDINGS_DIR", videos_dir / "Recordings")
