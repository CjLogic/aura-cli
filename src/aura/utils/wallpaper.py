...
from aura.utils.hypr import message
from aura.utils.material import get_colours_for_image
...
from aura.utils.scheme import Scheme, get_scheme
from aura.utils.theme import apply_colours
...
def get_smart_opts(wall: Path, cache: Path) -> str:
    ...
    from aura.utils.colourfulness import get_variant
